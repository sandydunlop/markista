...
/// files for each [package][../model/PackageNode] contained within, which in turn uses 
/// [TypeWriter] to output the Markdown files for each [type][../model/TypeNode] contained 
/// within.
